...
using TravelsalCoreProje.Areas.Member.Models;
    ...
    public class ProfileController : Controller
    {
		...
		public async Task<ActionResult> Index(UserEditViewModel p)
        {
            ...
            if (p.Image != null)
            {
                ...
                var savelaocation = resource + "/wwwroot/userimages/" + imagename;
                var stream = new FileStream(savelaocation, FileMode.Create);
