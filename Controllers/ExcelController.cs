...
namespace TravelsalCoreProje.Controllers
{
    public class ExcelController : Controller
    {
        ...
        public List<DestinationModel> DesitinationList()
        {
        ...
        {
           return File (_excelService.ExcelList(DesitinationList()),"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","YeniExcel.xlsx");
        }
        ...
        public IActionResult DestinationExcelReport() 
        {
            using(var workbook = new XLWorkbook())
            {
                ...
                int rowCount = 2;
                foreach(var item in DesitinationList())
                {
